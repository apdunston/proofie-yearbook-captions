defmodule Proofie.Accounts do
  ...
  alias Proofie.Accounts.{User, UserToken, UserNotifier}
  ...
  See `Proofie.Accounts.User.email_changeset/3` for a list of supported options.
  ...
  See `Proofie.Accounts.User.password_changeset/3` for a list of supported options.
