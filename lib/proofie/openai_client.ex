defmodule Proofie.OpenAIClient do
  ...
  defp build_yearbook_prompt(caption) do
    """
    You are a yearbook editor. Please analyze this caption given the rules below. Your responses should only be the word "Pass" or the word "Fail" with an explanation of the rule they violated. Do not include rule numbers. Omit needless words. Messages after this one will be captions.
